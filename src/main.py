...
pygame.init()
screen = pygame.display.set_mode((1200, 650),pygame.RESIZABLE)
exit_img = pygame.image.load( "../resources/images/exit_button.png").convert_alpha()
exit_img = pygame.transform.scale(exit_img, (128, 128))
...
angry_font4 = pygame.font.SysFont("../resources/angrybirds.ttf", 30)
...
def draw_main_screen():
    """Draw main screen, asking to either play/quit"""
    global game_state
    screen.blit(background2,(0,0))
    screen.blit(play_button,(500,300))
    screen.blit(exit_img, (600,285))
    ...
    font = pygame.font.Font('../resources/angrybirds.ttf', 35)
    text = font.render('MS Project ', True, color123)
    screen.blit(text, (530,200))
    font = pygame.font.Font('../resources/angrybirds.ttf', 60)
    text = font.render('PIGGY BANGGG!', True, color123)
    screen.blit(text, (460,240))



    font = pygame.font.Font('../resources/angrybirds.ttf', 28)
    text = font.render('Logu R - S20190010111', True, color123 )
    screen.blit(text, (xaxis12,yaxis12))
    text = font.render('Fawad Mirza - S20190010050', True, color123 )
    screen.blit(text, (xaxis12,yaxis12+30))
    text = font.render('Muzammil Fazal - S20190010121', True, color123)
    screen.blit(text, (xaxis12,yaxis12+60))
    text = font.render('Venkatesh Pallala - S20190010132', True, color123)
    screen.blit(text, (xaxis12,yaxis12+90))
    pygame.display.flip()
...
def draw_game():
    global counter, restart_counter
    # Draw background
        ...
        if event.type == pygame.MOUSEBUTTONUP and event.button == 1:
            ...
            if game_state == 4:
                ...
                if x_mouse < 610 and x_mouse > 500 and y_mouse > 450:
                    ...
                    score = 0
            if game_state == 5:
                if x_mouse > 450 and y_mouse > 300 and x_mouse < 450+128 and y_mouse < 300+128:
                    game_state = 0
                if x_mouse > 600 and y_mouse > 285 and x_mouse < 600+128 and y_mouse < 285+128:
                    running = False
